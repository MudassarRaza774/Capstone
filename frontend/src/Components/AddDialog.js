...
const initialData = {
    images: '', price: "", description: "", size: "", stuff: "", guidelines: '', catagory: "", name: "", color: ""
}
export default function AddDialog({ setDialogOpen }) {
